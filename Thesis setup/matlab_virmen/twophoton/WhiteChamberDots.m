        ...
        if numel(parts) == 2 && strcmp(parts{1}, 'FRAME')
            ...
            if ~isnan(currentFrame)
                ...
                if isnan(vr.startFrame)
                    ...
                    fprintf('WhiteChamberDots FIRST pulse | frame %.0f | %s\n', ...
                ...
                fprintf('WhiteChamberDots pulse | frame %.0f | t=%.3f s | %s\n', ...
                    currentFrame, currentElapsed, datestr(currentClock, 'yyyy-mm-dd HH:MM:SS.FFF'));
            end
        end
    end
end
